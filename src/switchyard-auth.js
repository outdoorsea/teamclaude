 ...
 * @param {number} [options.loopbackTimeoutMs] - how long the loopback flow waits
...
export async function authorizeSwitchyard(baseUrl = DEFAULT_BASE_URL, options = {}) {
  ...
  try {
    ...
    if (/** @type {Error & { code?: string }} */ (err).code === 'DEVICE_FLOW_UNSUPPORTED') {
...
/** @param {string} baseUrl @param {{ fetchFn: any, log: any, opener: any }} opts */
...
/** @param {string} baseUrl @param {{ fetchFn?: any, log: any, opener: any, timeoutMs?: number }} opts */
